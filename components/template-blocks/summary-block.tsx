...
export default function SummaryBlock({ block, templateType }: SummaryBlockProps) {
  ...
  return (
    <div className="summary-block mb-[var(--block-spacing)]">
      <TemplateHeading templateType={templateType}>Introduction.</TemplateHeading>

      <MarkdownViewer markdown={content.content} className="text-sm text-gray-800 space-y-2" />
    </div>
  )
}
