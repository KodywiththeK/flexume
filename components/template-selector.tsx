    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div>
        ...
        <RadioGroup
          ...
          onValueChange={(value) =>
            updateTemplate(value as "classic" | "modern" | "minimal")
          }
            ...
            <div className="space-y-4">
              <div className="grid gap-2">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    updateTemplateStyle({ fontFamily: value })
                  }
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="spoqa-han-sans">
                      Spoqa Han Sans
                    </SelectItem>
              ...
              <div className="grid gap-2">
                ...
                <div className="flex items-center gap-4">
                  <Slider
                    ...
                    className="flex-1"
                    onValueChange={(value) =>
                      updateTemplateStyle({ fontSize: `${value[0]}px` })
                    }
                  />
              ...
              <div className="grid gap-2">
                ...
                <div className="flex items-center gap-4">
                  <Slider
                    ...
                    className="flex-1"
                    onValueChange={(value) =>
                      updateTemplateStyle({ lineHeight: value[0] })
                    }
                  />
              ...
              <div className="grid gap-2">
                ...
                <div className="flex gap-2">
                  <Input
                    ...
                    onChange={(e) =>
                      updateTemplateStyle({ accentColor: e.target.value })
                    }
                  />
                  <Input
                    type="text"
              ...
              <div className="grid gap-2">
                ...
                <div className="flex items-center gap-4">
                  <Slider
                    ...
                    className="flex-1"
                    onValueChange={(value) =>
                      updateTemplateStyle({ blockSpacing: `${value[0]}px` })
                    }
                  />
